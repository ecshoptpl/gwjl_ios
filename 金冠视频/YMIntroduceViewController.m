...
#import "YMIntroduceViewController.h"
#import <YYImage/YYImage.h>
#import "AppDelegate.h"

@interface YMIntroduceViewController () <UIScrollViewDelegate>
...
@end@implementation YMIntroduceViewController {
    NSArray *gifNames;
...
- (void)setupViews {
    ...
    _scrollView = ({
        ...
        scrollView.backgroundColor = YMViewControllerBGColor;
...
- (void)entry {
    NSString *version = [YMUtilities appCurrentVersion];
    NSString *build = [YMUtilities appCurrentBuild];
    NSString *versionAndBuild = [NSString stringWithFormat:@"%@_%@", version, build];
    [UserDefaults setObject:versionAndBuild forKey:YMLastShowIntroduceVersionAndBuild];
