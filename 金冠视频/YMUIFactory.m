...
@implementation YMUIFactory

#pragma mark - UIView

+ (UIView *)separatorLine {
    UIView *view = [UIView new];
    view.backgroundColor = YMSeparatorColor;
...
+ (UIButton *)buttonWithImageName:(NSString *)imageName selectedImageName:(NSString *)selectedImageName target:(id)target action:(SEL)action {
    UIButton *button = [YMUIFactory buttonWithImageName:imageName highlightImageName:nil target:target action:action];
